/**
 * X11 Graphics Context implementation (software rasterizer)
 */
...
// ============================================================================
// Software Graphics Context for X11
// ============================================================================
    ...
    void draw_bitmap(const RectF& dest, const RectF& src, const Bitmap& bitmap) override {
        ...
        for (i32 y = 0; y < dest_h; ++y) {
            for (i32 x = 0; x < dest_w; ++x) {
                ...
                if (src_x < 0 || src_x >= bitmap.width || src_y < 0 || src_y >= bitmap.height) continue;
